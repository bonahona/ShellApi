...
<h1 class="page-header"><?php echo $Project->TitleName;?></h1>
...
<?php echo $this->PartialView('Classes', array('NamespacesExists' => $NamespacesExists, 'NamespacedClasses' => $NamespacedClasses, 'PublicClasses' => $PublicClasses, 'ExternalClasses' => $ExternalClasses, 'Project' => $Project));?>
